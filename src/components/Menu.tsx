  ...
  return (
    <section id="menu" className="py-24 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {newestAnnouncement && (
          <div className="mb-8 rounded-2xl bg-blue-50 border border-blue-100 px-6 py-5">
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Explore our latest products. Items marked as new are recently published by the admin team.
          </p>
        </motion.div>
