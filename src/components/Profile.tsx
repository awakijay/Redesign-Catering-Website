...
const cardClass = 'rounded-2xl bg-white p-5 shadow-xl sm:p-6 lg:p-8';
...
export function Profile() {
  ...
  useEffect(() => {
    ...
    const userQuotes = allQuotes.filter((quote: QuoteRequest) => quote.email === user?.email);
    ...
    const conversation = allMessages.filter((message) => message.userEmail === user?.email);
    ...
    <div className="min-h-screen bg-gray-50 py-8 sm:py-10 lg:py-12">
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="mb-6 flex flex-col gap-4 sm:mb-8 sm:flex-row sm:items-center sm:justify-between">
            ...
            <motion.button
              ...
              className="flex w-full items-center justify-center gap-2 rounded-full bg-red-600 px-5 py-2.5 text-white transition-colors hover:bg-red-700 sm:w-auto sm:px-6 sm:py-3"
            >
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
            {[
              ...
              return (
                <div key={item.label} className="flex items-center gap-4 rounded-xl bg-gray-50 p-4">
        ...
        <div className="mb-8 grid grid-cols-1 gap-8 lg:grid-cols-3">
          <section className="rounded-2xl bg-white p-5 shadow-xl sm:p-6 lg:col-span-2 lg:p-8">
            <h2 className="text-2xl font-bold text-gray-900">Latest Updates</h2>
            <p className="mb-6 text-gray-600">Announcements and new product updates from admin.</p>
          ...
          <section className="rounded-2xl bg-white p-5 shadow-xl sm:p-6">
            ...
            <div className="mb-4 h-64 space-y-3 overflow-y-auto rounded-lg bg-gray-50 p-3">
        ...
        >
          ...
          {quoteRequests.length === 0 ? (
            <div className="py-12 text-center">
              ...
              <p className="mb-6 text-gray-600">Start by submitting a quote request for your event.</p>
              <motion.button
